<template>
  <el-table ref="table" stripe border :data="table" size="small" @selection-change="onSelectionChange" @sort-change="onSortChange" :max-height="maxHeight" :row-class-name="tableRowClassName" @cell-click="cellClick">
